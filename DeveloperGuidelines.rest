...
1. **Do** document your code appropriately<br/>As a rule of thumb provide a
...
4. **Do** ask for help<br/>Ask questions via IRC, email or in person if you
...
2. **Don't** put the first working version up for review<br/>Go, have a break
...
3. **Don't** fight Rails (it'll beat you)<br/>Sometimes Rails' "magic" is
...
3. **Don't** use absolute paths/url's in any code (use url_for
   instead)<br/>*Always* let Rails generate URLs. You have to assume that
