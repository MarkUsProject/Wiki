...
- **User Name:** The user name of the grader.
...
- **User Name:** The user name of the student.
...
**1.  Assign grader(s):** To perform this action you must select a grader from the grader table and at least one student from the student table by clicking on their checkboxes. Then, click the "Assign grader(s)" button:
