...
- At least one of the two "Visibility" boxes must be selected.
    - The "Make visible to graders and admins" box should be selected if you want the criterion to be available to your TAs for marking. Note that if you do not have any TAs or you wish to grade this assignment yourself using this criterion, this box must still be selected.
