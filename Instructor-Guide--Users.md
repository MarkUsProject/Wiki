...
This page allows you to view a table of all the current graders set up for this course. Each row of the table includes the grader's username, first and last name(s), an email address and an action's column. To add a new grader click on the "Add a Grader" link on the top right hand corner of the page:
