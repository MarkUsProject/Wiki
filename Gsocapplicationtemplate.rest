...
Please answer the following questions for your MarkUs GSoC project application. It will help us getting a better understanding of what your experience with certain technologies and tools is. Certain ideas will require more skills than others. Don't be discouraged if you don't have experience with all technologies mentioned in questions below.
  ...
  5. Rate your Subversion skills (1 = Subversion? what's that?; 5 = I'm comfortable using it; 10 = I have written most the Subversion code)
  6. Do you know how to profile Ruby code? If you have any experience, explain what you've done.
  7. If you were to develop something involving Apache Ant, Ruby, virtual machines, SSH, and Linux how would that make you feel? Rating: 1 = Sounds like a little too much for my taste. 5 = I'm intrigued. Might be able to pull that off. 10 = I'm excited, when can I start. I've pretty much used all of it before.
  8. What do you like most about open source projects? What would make you stay as a MarkUs contributor after doing GSoc?
