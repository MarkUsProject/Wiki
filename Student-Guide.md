...
If you have uploaded one file to submit, you will have the option to rename it. You will get one of three different input-boxes to rename your file based on assignment configuration.
