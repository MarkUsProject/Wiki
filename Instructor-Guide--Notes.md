...
> 🗒️ **NOTE:** Every note type can be created from this page. However, the only type of note that CANNOT be created on the notes page is a grouping note. Please see the [notes](Instructor-Guide--Assignments--Marking--Grading-View.md#notes) section of the "Marking an Assignment" page for detailed instructions.
